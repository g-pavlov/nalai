...
Contains the WorkflowNodes class that implements the individual nodes
of the LangGraph workflow, including API selection, caching,
model response generation, and tool execution.
"""
...
class WorkflowNodes:
    """Workflow nodes for AI-powered API interactions.
    Implements individual nodes that:
    - Select relevant APIs based on conversation context
    - Manage conversation history with intelligent compression
    ...
    def select_relevant_apis(
        ...
        prompt, model = WorkflowNodes.create_prompt_and_model(
    ...
    def generate_model_response(
        ...
        prompt_template, model = WorkflowNodes.create_prompt_and_model(
