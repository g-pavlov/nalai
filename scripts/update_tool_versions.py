...
class ToolVersionUpdater:
    ...
    def _get_github_latest_release(self, repo: str) -> Optional[str]:
    ...
    def _get_pypi_latest_version(self, package: str) -> Optional[str]:
    ...
    def _get_docker_latest_version(self) -> Optional[str]:
    ...
    def run(self, tools: Optional[List[str]] = None, force: bool = False) -> None:
