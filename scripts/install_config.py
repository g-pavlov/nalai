...
class InstallConfig:
    ...
    def get_package_name(self, tool_name: str, pkg_manager: Optional[str] = None) -> Optional[str]:
    ...
    def get_special_install_method(self, tool_name: str, os_name: Optional[str] = None, 
                                 pkg_manager: Optional[str] = None) -> Optional[Dict[str, Any]]:
    ...
    def get_required_version(self, tool_name: str) -> Optional[str]:
    ...
    def get_min_version(self, tool_name: str) -> Optional[str]:
    ...
    def get_version_check_command(self, tool_name: str) -> Optional[str]:
    ...
    def is_version_compatible(self, tool_name: str, current_version: Optional[str] = None) -> bool:
