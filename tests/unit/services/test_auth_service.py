...
from api_assistant.config import settings
...
class TestAuthService:
    ...
    @pytest.mark.asyncio
    async def test_authenticate_request_with_id_token(self, mock_settings, valid_jwt_token, mock_request):
    ...
    @pytest.mark.asyncio
    async def test_authenticate_request_with_authorization_header(self, mock_settings, valid_jwt_token, mock_request):
    ...
    @pytest.mark.asyncio
    async def test_authenticate_request_invalid_token(self, mock_settings, invalid_jwt_token, mock_request):
    ...
    @pytest.mark.asyncio
    async def test_authenticate_request_missing_sub_claim(self, mock_settings, mock_request):
    ...
    def test_user_context_properties(self):
        ...
        identity = IdentityContext(user_id="test-user", email="test@example.com", token_type="access_token")
    ...
    @pytest.mark.asyncio
    async def test_extract_identity_with_string_roles(self, mock_settings, mock_request):
    ...
    @pytest.mark.asyncio
    async def test_extract_identity_with_missing_optional_fields(self, mock_settings, mock_request):
